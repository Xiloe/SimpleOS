;;; =================================================================================================================================================
;;; bootSector.asm: Simple Bootloader that uses 0x13 interrupt with ah=0x02
;;; =================================================================================================================================================
;;; https://wiki.osdev.org/Boot_Sequence
;;; https://en.wikipedia.org/wiki/BIOS_interrupt_call#Interrupt_table
;;; =================================================================================================================================================

        org 0x7C00              ; Resets ML (Memory Location Counter)

        ;; ==========================================================================================================================================
        ;; MBR - Load disk sectors
        ;; ==========================================================================================================================================
        ...
        ;; Load in the kernel and never return from it
        jmp 0x2000:0
